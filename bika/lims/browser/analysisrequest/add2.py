...
class ajaxAnalysisRequestAddView(AnalysisRequestAddView):
    ...
    def get_template_info(self, obj):
        ...
        profile_uid = profile and api.get_uid(profile) or ""
        profile_title = profile and profile.Title() or ""

        sample_type = obj.getSampleType()
        sample_type_uid = sample_type and api.get_uid(sample_type) or ""
        sample_type_title = sample_type and sample_type.Title() or ""

        sample_point = obj.getSamplePoint()
        sample_point_uid = sample_point and api.get_uid(sample_point) or ""
